    ...
    return <div>
        ...
        <div className="flex justify-center">
            <div className="max-w-xl">
                <BlogCard
                    authorName="Peter V"
                    title="How Spring Component Works"
                    content="Thomas Cook Group plc was a global travel group, headquartered
             in the United Kingdom and listed on the London Stock Exchange from its
